...
#pragma GCC diagnostic pop
        if (n_leaf == NULL) [[unlikely]] raise(SIGSEGV);
        uint8_t* data_ptr = reinterpret_cast<uint8_t*>(n_leaf) + leaf_bytes;
    ...
    /**
     * @brief Get the number of blocks currenty allocated by this allocator
     * instance.
     *
